...
{"type": "direct_channel", "direct_channel": {"members": ["` + username + `"]}}
...
{"type": "direct_post", "direct_post": {"channel_members": ["` + username + `"], "user": "` + username + `", "message": "Hello Direct Channel to myself", "create_at": 123456789014}}
